...
FunctionsToExport = 'GenerateGuidAsString', 'HasLocalAdministratorClaim', 
               ...
               'Ensure-NuGetSourceRegistered', 
               'Ensure-NuGetPackageProviderInstalled', 
               'Ensure-PowerShellGetLatest'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Lib/0.0.0.22/Content/LICENSE.txt'
